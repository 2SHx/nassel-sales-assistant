...
const SalesHub: React.FC = () => {
    ...
    const handleFilterChange = (filters: FilterState) => {
        ...
        // Note: 'unitType' filtering usually requires checking internal units, but if we have project-level metadata:
        ...
        // Area (using min_available_area as proxy for valid range check)
        ...
        <div className="relative h-screen w-screen overflow-hidden bg-slate-100 font-sans" dir="rtl">
            ...
            <MarketInsights
                ...
                onSelectProject={(p) => {
                    ...
                    // Optional: Fly to project if we had a map ref
                }}
            />
